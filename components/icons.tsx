...
export const TikTokIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.03-4.83-.95-6.43-2.88-1.59-1.93-2.23-4.52-2.09-7.03.03-2.5.99-4.9 2.51-6.73 1.91-2.26 4.75-3.52 7.69-3.56.09 2.52.02 5.04.02 7.56C12.11 11.96 12 11.53 12 11.02c-.01-1.22-.01-2.45-.02-3.68-.02-1.31-.02-2.61 0-3.92.01-1.31.02-2.62.02-3.93Z"></path>
  </svg>
);
...
export const RegenerateIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.664 0l3.181-3.183m-11.664 0-3.181 3.183m0 0-3.181-3.183m3.181 3.183L9.348 16.023m-4.242 0H1.5" />
    </svg>
);
...
export const WandIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-2.25-1.326l-3.326-.443a3 3 0 0 1-2.25-2.983V6.586a3 3 0 0 1 2.25-2.983l3.326-.443a3 3 0 0 0 2.25-1.326L8.99 1.25l1.522 2.636a3 3 0 0 0 2.25 1.326l3.326.443a3 3 0 0 1 2.25 2.983v1.633a3 3 0 0 1-2.25 2.983l-3.326.443a3 3 0 0 0-2.25 1.326L11.01 22.75l-1.522-2.636Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.636-5.636" />
    </svg>
);
...
export const LayersIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 0 1 3-3h.008a3 3 0 0 1 3 3v8.25a3 3 0 0 1-3 3h-.008Z" />
    </svg>
);

export const HeartIcon: React.FC<{ className?: string }> = ({ className = 'w-8 h-8' }) => (
...
export const ChatBubbleIcon: React.FC<{ className?: string }> = ({ className = 'w-8 h-8' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} stroke="none">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-0.481M21 12a9 9 0 0 0-9-9c-5.185 0-9.448 4.023-9.975 9.123A9.962 9.962 0 0 0 3 12c0 4.556 4.03 8.25 9 8.25" />
    </svg>
);

export const MusicNoteIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 9V4.5M9 9c0-1.105 2.686-2 6-2s6 .895 6 2v6c0 1.105-2.686 2-6 2s-6-.895-6-2V9Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 9H3v6c0 1.105 2.686 2 6 2s6-.895 6-2V9" />
    </svg>
);